...
Public Class laporan_pegawai
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_Salary.laporan pegawai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_pegawai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_pegawai = New laporan_pegawai()
        rpt.Site = Me.Site
        Return rpt
    End Function
