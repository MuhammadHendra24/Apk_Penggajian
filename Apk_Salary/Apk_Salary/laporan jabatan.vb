...
Public Class laporan_jabatan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_Salary.laporan jabatan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_jabatan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_jabatan = New laporan_jabatan()
        rpt.Site = Me.Site
        Return rpt
    End Function
