...
Public Class laporan_golongan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_Salary.laporan golongan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_golongan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_golongan = New laporan_golongan()
        rpt.Site = Me.Site
        Return rpt
    End Function
