...
Public Class laporan_penggajian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_Salary.laporan penggajian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_penggajian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_penggajian = New laporan_penggajian()
        rpt.Site = Me.Site
        Return rpt
    End Function
