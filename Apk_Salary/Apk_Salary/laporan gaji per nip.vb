...
Public Class laporan_gaji_per_nip
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "laporan gaji per nip.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_Salary.laporan gaji per nip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_gaji_per_nip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_gaji_per_nip = New laporan_gaji_per_nip()
        rpt.Site = Me.Site
        Return rpt
    End Function
