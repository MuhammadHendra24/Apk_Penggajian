...
Public Class laporan_petugas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_Salary.laporan petugas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_petugas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_petugas = New laporan_petugas()
        rpt.Site = Me.Site
        Return rpt
    End Function
