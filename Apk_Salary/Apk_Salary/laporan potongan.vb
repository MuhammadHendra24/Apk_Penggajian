...
Public Class laporan_potongan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_Salary.laporan potongan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_potongan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_potongan = New laporan_potongan()
        rpt.Site = Me.Site
        Return rpt
    End Function
